...
def compare(theta1, theta2, r1, r2, angle, offset, type):
    ax = plt.subplot(111, polar=True)
    ax.plot(theta1, r1, color='r', linewidth=3, label='Baseline Path')
    ax.plot(theta2, r2, color='b', linewidth=3, label='Shielded Box')
    ax.grid(True)
